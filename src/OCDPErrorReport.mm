...
- (nullable OCDPBoundingReport *) bounding_report {
    ...
    OCDPBoundingReport * objcBoundingReport = [[OCDPBoundingReport alloc] initWithCppBoundingReport:bounding_report];
    return objcBoundingReport;
}

- (nullable OCDPConfidenceInterval *) noise_confidence_interval {
    ConfidenceInterval confidence_interval = cpp_Errorreport->noise_confidence_interval();
    OCDPConfidenceInterval * objcConfidenceInterval = [[OCDPConfidenceInterval alloc] initWithCppConfidenceInterval:confidence_interval];
